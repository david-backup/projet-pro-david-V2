...
export const APP_NAME = "David Projects";
//
//Définition variable le nom du développeur pour le copyright
export const APP_DEV = "David Changea";
//
//
//
// Définition de la variable `basename` en fonction du mode de l'environnement
// "/" correspond au nom du dossier ou se trouvera le site en production (hors racine domaine)
